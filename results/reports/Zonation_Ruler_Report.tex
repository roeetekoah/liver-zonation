...
\author{Auto-generated}\date{2026-06-22}
...
CO-PRIMARY rulers (frozen on HEALTHY metrics only; eligibility = leakage-clean, i.e. NOT fit on Paper-1 cells -- publishability is NOT a criterion):

  [interpretable / published anchor] expanded_curated: score=+1.149, anticorr=-0.479, split-half=+0.670, markers=8/8, 26 PC + 23 PP
  [label-free / learned, external to Paper 1] unsupervised_p2: score=+1.162, anticorr=-0.471, split-half=+0.691, markers=8/8, 5177 PC + 3302 PP

Highest healthy score among ALL eligible rulers: unsupervised_p2.
Interpretable vs label-free healthy-score gap = 0.012 (within the 0.02 tie band) -- reported side-by-side; the headline rests on their agreement, not on either alone.

Excluded from the competition (fit on Paper-1 cells -> in-sample healthy metrics, kept as H1 robustness controls): unsupervised, unsupervised_combined.
selected_frozen.txt = copy of the interpretable anchor (for downstream H2b/H2c).
WARNING: selection used HEALTHY-atlas criteria ONLY, NOT Paper 1 disease effect (disease is the transfer/test cohort, not the tuning cohort).
\end{verbatim}
\clearpage
\section*{unsupervised\_combined \hfill control (Paper1-fit)}
...
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_unsupervised_combined.png}\end{center}
\clearpage
\section*{unsupervised\_p2 \hfill PRIMARY (label-free)}
...
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_unsupervised_p2.png}\end{center}
\clearpage
\section*{expanded\_curated \hfill PRIMARY (interpretable)}
...
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_expanded_curated.png}\end{center}
\clearpage
\section*{selected\_frozen \hfill primary\_candidate}
Copy of the interpretable co-primary anchor (best leakage-clean PUBLISHED set by healthy metrics); drives downstream H2b/H2c. \textbf{Genes:} 26 PC + 23 PP.
\paragraph{Validation (8-marker healthy gate) \& controls.} Markers correct: 8/8 (PASS). Healthy PC--PP anticorrelation = -0.479 (want strongly negative); split-half reproducibility = +0.670; coherence PC/PP = +0.155/+0.065.
\paragraph{H1 (donor-level collapse, TRANSFER).} coord-spread vs stage rho = -0.434 (perm p = 0.003); PC--PP anticorr trend rho = +0.612 (perm p = 0.0005).
\paragraph{H2 (zonal slope-loss, held-out).} 49 genes tested; 90\% weaken; median trend rho = -0.258.
\paragraph{H3 (de-zonation $\leftrightarrow$ plasticity, donor-level).} mean rho = +0.025; 33/47 donors $>$0; sign-test p = 0.0079.
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_selected_frozen.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_unsupervised_top100.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_unsupervised_top50.png}\end{center}
\clearpage
\section*{unsupervised \hfill control (Paper1-fit)}
...
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_unsupervised.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_paper2_landmark.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_unsupervised_top250.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_paper2_top50.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_paper2_top100.png}\end{center}
\clearpage
...
\paragraph{H2 (zonal slope-loss, held-out).} 8488 genes tested; 61\% weaken; median trend rho = -0.048.
\paragraph{H3 (de-zonation $\leftrightarrow$ plasticity, donor-level).} mean rho = -0.008; 21/47 donors $>$0; sign-test p = 0.56.
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_unsupervised_full.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_core_curated.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_unsupervised_lasso.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_unsupervised_elasticnet.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_paper2_top250.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_paper2_full.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_full.png}\end{center}
\clearpage
...
\begin{center}\includegraphics[width=0.92\textwidth]{C:/liver-zonation/results/figures/collapse_supervised.png}\end{center}
\clearpage
\end{document}
