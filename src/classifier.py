...
Needs: data/raw/combined_scRNAseq_atlas_M5M6M7M8.mat (Paper 2) + data/processed/paper1/
(Paper 1) + the signature files. Memory: restricts to a shared feature-gene set, so it
stays light.
Run from the src/ folder:  python classifier.py
"""
import os, sys, numpy as np, pandas as pd, h5py, scipy.io
