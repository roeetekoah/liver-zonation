...
\code{paper2\_train.npz} must be rebuilt so its feature genes are the full zonated set, not just
the $40$ landmark genes.
...
\code{paper2\_landmark} & $20 / 20$ exact & Paper 2 landmark baseline \\
\bottomrule
\end{tabular}
\end{center}
